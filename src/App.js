    ...
    <div className="App">
        ...
        <section className="my-services" id="services">
            ...
            <div className="services">
                ...
                <div className="service">
                    <h3>Skills</h3>
                    <p>ReactJS | Redux | NodeJS | ExpressJS | AngularJS | JavaScript |  TypeScript | Axios | RESTful API | ES6 | HTML5 | CSS3 | Google Analytics |  Agile | Scrum | Flexbox | Kendo UI | TailwindCSS | Docker | Git | GitHub | Gitlab | Linux | Ruby on Rails | MVC | Webpack| Bootstrap.</p>
                </div> 
                ...
                <div className="service">
                    ...
                    <p>I'm a more UI focused developer. I'm familiar with React 
                      ...
                      I always like to keep in consistent communication with product teams, 
